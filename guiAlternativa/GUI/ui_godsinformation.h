...
public:
    ...
    void setupUi(QMainWindow *godsInformation)
    {
        ...
        label_2->setPixmap(QPixmap(QString::fromUtf8("../../Escritorio/imagenes GUI/imagen52.png")));
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(140, 110, 81, 81));
        label_3->setPixmap(QPixmap(QString::fromUtf8("../../Escritorio/imagenes GUI/imagen53.png")));
        label_4 = new QLabel(centralwidget);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(250, 110, 71, 81));
        label_4->setPixmap(QPixmap(QString::fromUtf8("../../Escritorio/imagenes GUI/imagen54.png")));
        label_5 = new QLabel(centralwidget);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(360, 100, 71, 91));
        label_5->setPixmap(QPixmap(QString::fromUtf8("../../Escritorio/imagenes GUI/imagen55.png")));
